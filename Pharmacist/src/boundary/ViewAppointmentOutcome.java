...
public class ViewAppointmentOutcome {
    ...
    public void displayAppointmentOutcome() {
        ...
        List<Appointment> records = pharmacistView.getAppointmentRecords(patientId);
        System.out.println("\nPatient Name: " + patient.getName());
        System.out.println("Medicines Prescribed:");

        for (Appointment record : records) {
            System.out.println("Medicine: " + record.getMedications() + 
        ...
        if (choice.equalsIgnoreCase("yes")) {
            ...
            boolean updated = pharmacistView.updatePrescriptionStatus(patientId, medicineName, MedicationStatus.DISPENSED);
            if (updated) {
